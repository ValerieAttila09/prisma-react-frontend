  ...
  return (
    <div className="w-full py-[3rem] sm:py-[5rem] px-4 sm:px-8 md:px-[4rem]">
      <div className="relative w-full h-[calc(100vh-10rem)]">
        <img src={Plane} className="mx-auto my-auto w-4/5 h-[98%] object-cover" alt="" />
        <div className="absolute z-5 inset-0 bg-transparent pt-[1rem] flex items-start justify-center">
        ...
        <div className="absolute z-5 top-[16rem] left-[19rem]">
          
        </div>
        <div className="absolute z-5 inset-0 pt-[17rem] bg-transparent flex flex-col items-center justify-center gap-3">
          ...
          <div className="w-full flex items-center justify-center gap-2">
            ...
            <Link to={"/"} className="p-[2px] rounded-lg overflow-hidden bg-gradient-to-br from-blue-500 via-cyan-400 to-sky-500 group">
              <div className="rounded-md px-5 py-2 bg-white group-hover:bg-blue-50 transition-all">
                Cari Tiket Murah
              </div>
            </Link>
          </div>
